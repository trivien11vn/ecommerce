    ...
    <div className='w-full'>
        <div className='h-[103px] w-full bg-main flex justify-center items-center'>
          <div className='w-main flex items-center justify-between'>
            ...
            <input className='w-full p-4 pr-0 rounded-l-full bg-[#f04646] outline-none text-gray-100 placeholder:text-sm placeholder:text-gray-200 placeholder:italic placeholder:opacity-50' type='text' placeholder='Email address'/>
        ...
        <div className='h-[407px] w-full bg-gray-800 flex justify-center items-center text-white text-[13px]'>
          <div className='w-main flex'>
            <div className='flex-2 flex flex-col gap-2'>
              <h3 className='mt-[20px] text-[15px] font-medium border-l-2 border-main pl-[15px]'>ABOUT US</h3>
              <span>
                <span>Address: </span>
            ...
            <div className='flex-1 flex flex-col gap-2'>
              <h3 className='mt-[20px] text-[15px] font-medium border-l-2 border-main pl-[15px]'>INFORMATION</h3>
            ...
            <div className='flex-1 flex flex-col gap-2'>
              <h3 className='mt-[20px] text-[15px] font-medium border-l-2 border-main pl-[15px]'>#DIGITALWORLDSTORE</h3>
            </div>
          </div>
        </div>
    </div>
